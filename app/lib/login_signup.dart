...
================================================
This file is responsible for managing secure logins and registrations through Firebase.
Based off the template provided by https://medium.com/swlh/flutter-login-registration-using-firebase-1bef34007b91
*/
  ...
  Widget build(BuildContext context) {
    ...
    void loginSheet() {
      _sheetController = _scaffoldKey.currentState
        ...
        return DecoratedBox(
          decoration: BoxDecoration(color: Color.fromARGB(255, 44, 47, 51)),
          child: ClipRRect(
